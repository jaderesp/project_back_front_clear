	...
	return(
		<>
			...
			<div className="d-flex">
				<p className="font-w500 me-auto mb-2 title fs-20"><Link to={"/post-details"} className="text-black">{titleMenu}</Link></p>
				<DropdownBlog />
			</div>
			<div className="mb-3"><i className="far fa-calendar me-3" aria-hidden="true"></i>Created on Sep 8th, 2023</div>
			<div className="media align-items-center">
				<div className="power-ic me-3">
					<i className="fa fa-bolt" aria-hidden="true"></i>
				</div>
				<div className="media-body">
					<p className="mb-1">Deadline</p>
					<span className="text-black font-w600">Tuesday,  Sep 29th 2023</span>
				</div>
			</div>
		</>
	)	
